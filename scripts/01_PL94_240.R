...
# Define documents
documentA <- paste(readLines("machine_readable/PL94_240.txt"), collapse = "\n")
documentB <- paste(readLines("gpt_txt/PL94_240_gpt.txt"), collapse = "\n")
...
save(PL94_240_word_count, file = "results/PL94_240_word_count.rda")
...
# save
PL094_240_accuracy <- 
  tibble(law = "PL094_240", ocr = proportionA_not_in_B, gpt = proportionB_not_in_A)

save(PL094_240_accuracy, file = "results/PL094_240.rda")
