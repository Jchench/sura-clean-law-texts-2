...
# Define documents
documentA <- paste(readLines("machine_readable/PL102_242_2334.txt"), collapse = "\n")
documentB <- paste(readLines("gpt_txt/PL102_242_2334_gpt.txt"), collapse = "\n")
...
# save
PL102_242_2334_word_count <- 
  tibble(law = "PL102_242_2334",
...
save(PL102_242_2334_word_count, file = "results/PL102_242_2334_word_count.rda")
...
# save
PL102_242_2334_accuracy <- 
  tibble(law = "PL102_242_2334", ocr = proportionA_not_in_B, gpt = proportionB_not_in_A)

save(PL102_242_2334_accuracy, file = "results/PL102_242_2334.rda")
