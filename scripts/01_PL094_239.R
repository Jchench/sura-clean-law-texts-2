...
save(PL094_239_word_count, file = "results/PL094_239_word_count.rda")
...
# save
PL094_239_accuracy <- 
  tibble(law = "PL094_239", ocr = proportionA_not_in_B, gpt = proportionB_not_in_A)

save(PL094_239_accuracy, file = "results/PL094_239.rda")
