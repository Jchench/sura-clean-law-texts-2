...
# Define documents
documentA <- paste(readLines("machine_readable/PL098_181_1278.txt"), collapse = "\n")
documentB <- paste(readLines("gpt_txt/PL098_181_1278_gpt.txt"), collapse = "\n")
...
# save
PL098_181_1278_word_count <- 
  tibble(law = "PL098_181_1278",
...
save(PL098_181_1278_word_count, file = "results/PL098_181_1278_word_count.rda")
