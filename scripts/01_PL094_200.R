...
save(PL094_200_word_count, file = "results/PL094_200_word_count.rda")
...
# save
PL094_200_accuracy <- 
  tibble(law = "PL094_200", ocr = proportionA_not_in_B, gpt = proportionB_not_in_A)

save(PL094_200_accuracy, file = "results/PL094_200.rda")
